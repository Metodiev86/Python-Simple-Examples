...
class Ui_Fresh_form(object):
    def setupUi(self, Fresh_form):
        ...
        self.listView = QtWidgets.QListView(Fresh_form)
        self.listView.setGeometry(QtCore.QRect(0, 140, 391, 531))
        font = QtGui.QFont()
        font.setFamily("Candara")
        ...
        self.listView.setInputMethodHints(QtCore.Qt.ImhMultiLine|QtCore.Qt.ImhUppercaseOnly)
        ...
        self.listView.setBatchSize(500)
